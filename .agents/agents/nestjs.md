...
<!-- Gerado de .claude/agents/nestjs.md por gen-antigravity.mjs — não edite à mão. -->
...
4. Read `CLAUDE.md`.
5. Read `.agents/skills/nestjs/SKILL.md` if available (or `~/.gemini/config/skills/nestjs/SKILL.md` if buildison is installed globally).
