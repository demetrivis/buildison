...
<!-- Gerado de .claude/agents/logger.md por gen-antigravity.mjs — não edite à mão. -->
...
2. If the logging skill exists, read it for project conventions: `.agents/skills/logging/SKILL.md` and `.agents/skills/logging/references/`. Look in the project first; if buildison is installed globally, they're under `~/.gemini/config/skills/logging/`.
