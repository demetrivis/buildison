...
<!-- Gerado de .claude/agents/api.md por gen-antigravity.mjs — não edite à mão. -->
...
2. If the API skill exists, read it for project conventions: `.agents/skills/api/SKILL.md` and `.agents/skills/api/references/`. Look in the project first; if buildison is installed globally, they're under `~/.gemini/config/skills/api/`.
