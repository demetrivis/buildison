...
<!-- Gerado de .claude/agents/db.md por gen-antigravity.mjs — não edite à mão. -->
...
Before writing any code, read the database skill and its references for project conventions — in the project's `.agents/skills/`, or in `~/.gemini/config/skills/` if buildison is installed globally:
- `.agents/skills/database/SKILL.md`
- `.agents/skills/database/references/` (supabase-client, migrations, rls, repositories)
