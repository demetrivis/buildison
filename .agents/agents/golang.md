...
<!-- Gerado de .claude/agents/golang.md por gen-antigravity.mjs — não edite à mão. -->
...
3. Read `CLAUDE.md`.
4. Read `.agents/skills/golang/SKILL.md` if available (or `~/.gemini/config/skills/golang/SKILL.md` if buildison is installed globally).
