...
<!-- Gerado de .claude/agents/prisma.md por gen-antigravity.mjs — não edite à mão. -->
...
4. Read `CLAUDE.md`.
5. Read `.agents/skills/prisma/SKILL.md` if available (or `~/.gemini/config/skills/prisma/SKILL.md` if buildison is installed globally).
