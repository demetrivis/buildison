...
<!-- Gerado de .claude/agents/postgrest.md por gen-antigravity.mjs — não edite à mão. -->
...
3. Read `CLAUDE.md`.
4. Read `.agents/skills/postgrest/SKILL.md` if available (or `~/.gemini/config/skills/postgrest/SKILL.md` if buildison is installed globally).
5. Read `.agents/skills/database/SKILL.md` (or `~/.gemini/config/skills/database/SKILL.md` if buildison is installed globally) for shared Postgres/RLS conventions.
