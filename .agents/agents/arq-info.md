...
<!-- Gerado de .claude/agents/arq-info.md por gen-antigravity.mjs — não edite à mão. -->
...
and the output templates — in the project's `.agents/skills/`, or in `~/.gemini/config/skills/` if buildison is installed globally:

- `.agents/skills/plano-operacao/SKILL.md`
- `.agents/skills/plano-operacao/references/` (c4-conventions, structurizr-dsl, data-model-mdm, output-templates)
