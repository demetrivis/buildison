...
>
> Mantenha curto e verdadeiro. Decisões formais vão para [`decisions.md`](decisions.md); se você
> tiver rodado `/qdrant`, a memória de baixo atrito vai para o Qdrant (skill `agent-memory`).
